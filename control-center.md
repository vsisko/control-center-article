...
Поднобные детали для каждого спана также доступны.
...
Также здесь можно найти статискику по запросам с информацией о числе запусков, падений и времени исполнения.
...
Как было продемонстрировано ранее, для начала мониторига кластера необходимо воспользоваться специальным временным токеном. В такой схеме участвуют три идентификатора:
